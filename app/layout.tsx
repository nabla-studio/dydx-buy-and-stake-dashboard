          ...
          <Providers>
            ...
            <footer className="px-5 xl:px-10 2xl:container pt-20 pb-5">
              ...
              <p className=" leading-normal text-muted-foreground text-xs">
                ...
                publicly disclose any such change. Most of the information in
                this website has been obtained from third-party sources and has
                not been independently verified. nabla srl benefit corporation
                assumes no responsibility for the accuracy or completeness of
                the information in this website, which is made available to the
                public for free in good faith and for informational purposes
                only. Crypto-assets can be highly volatile and trading
                crypto-assets involves risk of loss, particularly when using
                leverage. Investment into crypto-assets may not be regulated and
                may not be adequate for retail investors. Do your own research
                and due diligence before engaging in any activity involving
                crypto-assets. dYdX is a decentralised, disintermediated and
                permissionless protocol, and is not available in the U.S. or to
                U.S. persons as well as in other restricted jurisdictions.
              </p>
            </footer>
          </Providers>
        </NuqsAdapter>
